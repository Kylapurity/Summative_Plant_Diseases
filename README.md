...
## Dataset 
### The dataset I used was a plant diseases data. it is used to predict and catorieges the images based on the disease and class: /kaggle/input/plant-dataset
